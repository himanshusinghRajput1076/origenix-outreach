...
export default function InvestorsPanel({ contacts, setContacts, companyProfile, smtpConfig, addToast }) {
    ...
    <div>
      ...
      {activeTab === 'upload' && (
        <div className="card">
          ...
          <ExcelUploader onContactsLoaded={handleContactsLoaded} variant="investor" />
        </div>
      )}
